...
let myPickup = Pickup(make: "Audi", model: "idk", modelYear: 2004, color: "Yellow", maxSpeed: 175, value: 35000, extendedCab: true, is4WD: false, isHeavyDuty: false)
...
// Answer: we could make sure we have default values for all properties and then create an empty initializer in the class properies types Optional
