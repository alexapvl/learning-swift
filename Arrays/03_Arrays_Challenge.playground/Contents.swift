...
// The swift language provides many built-in properties and methods for working with data types. You've been using some of them already. myArray.count, myArray.append(), etc are all functionality that Swift gives you for the array type. One nice thing about Xcode is that it will recommend properites and methods for you, and it will explain what they do. When you type a variable's name and type period, Xcode will make suggestions. Try it! On the next blank line, type primes.c and watch how Xcode suggests primes.count and tells you what it does! It even does partial matches. Type primes.verse and it matches primes.reverse.
...
var coordinates = [[1,2], [-1,4], [5,7], [0,10]]
...
let point3 = coordinates[2]   // get the 3rd element of the arrayOfPoints, which is [5,7]
