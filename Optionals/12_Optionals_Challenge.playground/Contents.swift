...
// Answer: Because if the value is nil, your program crashes.


// What is the difference between variable1 and variable2?
var variable1: [Int?] = [7]
var variable2: [Int?]? = [7]
// Answer: variable1 is an Array of optional Integers while variable2 is an optional Array of optional Integers
...
func deadOrAlive(catColour: String?) {
    guard let colour = catColour else {
        print("The cat is dead...")
        return
    }
    print("The cat is still alive! The colour of the cat is \(colour)")
}

deadOrAlive(catColour: schrodingersCat)
